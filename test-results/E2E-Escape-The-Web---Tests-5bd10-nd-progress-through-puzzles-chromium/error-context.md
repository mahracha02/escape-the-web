...
Locator: locator('.error-message').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('.error-message').first()

    at C:\Users\abdel\Desktop\Bachelor 3 Dev\test et qualité\EscapeTheWeb\escape-the-web\e2e\E2E.spec.ts:72:34
    at C:\Users\abdel\Desktop\Bachelor 3 Dev\test et qualité\EscapeTheWeb\escape-the-web\e2e\E2E.spec.ts:54:5
```
...
- heading "Le Coffre-Fort Secret" [level=2]
- button "Voir l'indice"
- heading "Carte Secrète" [level=3]
- paragraph: Grattez la carte pour révéler le mot de passe
- paragraph: Entrez le mot de passe révélé sur la carte.
- textbox "Entrez le mot de passe..."
- button "Valider"
- paragraph: Mot de passe incorrect. Essayez encore.
